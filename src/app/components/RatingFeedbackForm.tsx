...
export default function RatingFeedbackForm() {
  ...
  const courses = Array.from(new Map(mockSchedule.map(s => [s.courseCode, s.courseCode])).values())
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-6">
      <p className="text-sm text-gray-600 mb-6">Share your thoughts about your courses</p>

      <form onSubmit={handleSubmit} className="space-y-6">
        {/* Course & Professor Dropdowns */}
        <div>
          <label className="block text-sm font-semibold text-gray-700 mb-3">Select course and professor</label>
        ...
        <div>
          ...
          <StarRating label="Workload and difficulty" rating={workloadRating} onRating={setWorkloadRating} />
          <StarRating label="Course content" rating={contentRating} onRating={setContentRating} />
          <StarRating label="Professor" rating={professorRating} onRating={setProfessorRating} />
        </div>
        ...
        <div>
          ...
          <div className="relative">
            <textarea
              ...
              rows={4}
            />
            <div className="text-xs text-gray-500 mt-1">{feedback.length}/300 characters</div>
          </div>
        </div>
